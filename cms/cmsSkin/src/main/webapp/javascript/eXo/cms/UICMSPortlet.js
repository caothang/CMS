...
UICMSPortlet.prototype.OpenPrivateField = function(elm) {
	if(elm === "DivCheckBox") {
...
UICMSPortlet.prototype.OverButton = function(oject) {
...
UICMSPortlet.prototype.expandCollapse = function(obj) {
