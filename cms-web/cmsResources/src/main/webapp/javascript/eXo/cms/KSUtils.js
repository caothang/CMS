...
CheckBoxManager.prototype.checkAll = function() {
	eXo.cms.CheckBox.checkAllItem(this);
} ;
...
CheckBoxManager.prototype.check = function() {
	eXo.cms.CheckBox.checkItem(this);
} ;

CheckBoxManager.prototype.checkAllItem = function(obj){
	var checked = obj.checked ;
	var items = eXo.cms.CheckBox.getItems(obj) ;
...
CheckBoxManager.prototype.checkItem = function(obj){
	var checkboxes = eXo.cms.CheckBox.getItems(obj);
	var len = checkboxes.length;
	var state = true;
	if (!obj.checked) {
...
eXo.cms.CheckBox = new CheckBoxManager() ;
