UIDateTimePicker = function(calendarId) {
	...
	this.pathResource = "/forumResources/javascript/eXo/cms/lang/";
	this.lang = "";
...
UIDateTimePicker.prototype.init = function(field, isDisplayTime) {
	...
	eXo.cms.UIDateTimePicker.getLang() ;
...
UIDateTimePicker.prototype.show = function() {
	document.onmousedown = new Function('eXo.cms.UIDateTimePicker.hide()') ;
...
UIDateTimePicker.prototype.renderCalendar = function() {
	...
	table += 		'		<tr>' ;
	table += 		'			<td class="MonthButton"><a class="PreviousMonth" title="' + this.tooltip[1]+ '" href="javascript:eXo.cms.UIDateTimePicker.changeMonth(-1);"></a></td>' ;
	table += 		'			<td class="YearButton"><a class="PreviousYear" title="' + this.tooltip[0]+ '" href="javascript:eXo.cms.UIDateTimePicker.changeYear(-1);"></a></td>' ;
	table += 		'			<td><font color="#f89302">' + this.months[this.currentDate.getMonth()] + '</font> - ' + this.currentDate.getFullYear() + '</td>' ;
	table += 		'			<td class="YearButton"><a class="NextYear" title="' + this.tooltip[3]+ '" href="javascript:eXo.cms.UIDateTimePicker.changeYear(1);"></a></td>' ;
	table += 		'			<td class="MonthButton"><a class="NextMonth" title="' + this.tooltip[2]+ '" href="javascript:eXo.cms.UIDateTimePicker.changeMonth(1);"></a></td>' ;
	table += 		'		</tr>' ;
	table += 		'	</table>' ;
		...
		for (var dayOfWeek=0; dayOfWeek < 7; dayOfWeek++) {
		  var currentWeekDay = (dayOfWeek + this.fistWeekDay) % 7;
			...
			if (validDay) {
				...
				table = table + "<td><a class='"+clazz+"' href=\"javascript:eXo.cms.UIDateTimePicker.setDate("+this.currentDate.getFullYear()+","+(this.currentDate.getMonth() + 1)+","+dayOfMonth+")\">"+dayOfMonth+"</a></td>" ;
				dayOfMonth++ ;
			} else {
	...
	if (this.isDisplayTime) {
		...
		table += 		'			<div class="CalendarTimeBoxM"><span><input class="InputTime" size="2" maxlength="2" value="' +
								...
								'" onkeyup="eXo.cms.UIDateTimePicker.setHour(this)" >:<input size="2" class="InputTime" maxlength="2" value="' + 
								((this.currentDate.getMinutes())>9 ? this.currentDate.getMinutes() : "0"+this.currentDate.getMinutes()) + 
								'" onkeyup = "eXo.cms.UIDateTimePicker.setMinus(this)">:<input size="2" class="InputTime" maxlength="2" value="' + 
								((this.currentDate.getSeconds())>9 ? this.currentDate.getSeconds() : "0"+this.currentDate.getSeconds()) + 
								'" onkeyup = "eXo.cms.UIDateTimePicker.setSeconds(this)"></span></div>' ;
		table += 		'		</div>' ;
		table += 		'	</div>' ;
	}
	table += 		'</div>' ;
...
eXo.cms.UIDateTimePicker = new UIDateTimePicker('UICalendarControl') ;
