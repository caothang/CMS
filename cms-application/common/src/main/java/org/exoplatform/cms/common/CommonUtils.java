...
import org.exoplatform.cms.rendering.MarkupRenderingService;
import org.exoplatform.cms.rendering.api.Renderer;
import org.exoplatform.cms.rendering.core.SupportedSyntaxes;
...
public class CommonUtils {
  ...
  */
  ...
  public static String getRSSLink(String appType, String portalName, String objectId) {
    return SLASH + PortalContainer.getInstance().getRestContextName() + "/cms/" + appType + "/rss/" + objectId;
  }

  public static String getUserRSSLink(String apptype, String userId) {
    return SLASH + PortalContainer.getInstance().getRestContextName() + "/cms/" + apptype + "/rss/user/" + userId;
  }
