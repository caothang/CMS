 ...
 */
package org.exoplatform.cms.common.jcr;
...
public class JCRSessionManager implements SessionManager {
  ...
  /*
   * (non-Javadoc)
   * @see org.exoplatform.cms.common.jcr.SessionManager#getSession(org.exoplatform.services.jcr.ext.common.SessionProvider)
   */
  ...
  /*
   * (non-Javadoc)
   * @see org.exoplatform.cms.common.jcr.SessionManager#createSession()
   */
  ...
  /*
   * (non-Javadoc)
   * @see org.exoplatform.cms.common.jcr.SessionManager#closeSession()
   */
  ...
  /*
   * (non-Javadoc)
   * @see org.exoplatform.cms.common.jcr.SessionManager#closeSession(boolean)
   */
  ...
  /*
   * (non-Javadoc)
   * @see org.exoplatform.cms.common.jcr.SessionManager#executeAndSave(org.exoplatform.cms.common.jcr.JCRTask)
   */
  ...
  /*
   * (non-Javadoc)
   * @see org.exoplatform.cms.common.jcr.SessionManager#execute(org.exoplatform.cms.common.jcr.JCRTask)
   */
